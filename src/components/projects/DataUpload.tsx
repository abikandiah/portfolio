...
export const dataUploadProject: ProjectProps = {
    ...
    name: 'Data Upload',
    duration: '2020',
    description: `A data set upload tool for uploading data to admin-defined repositories. Implements the tus resumable file upload protocol with the help of two open source projects; Uppy for the frontend and another for the backend.`,
...
function Overview() {
    return (
        <>
            ...
            <p>
                The data upload tool follows the tus resumable file upload protocol and allows pausing and resuming multiple uploads. It was implemented with two open source projects. We started with the open source implementations and then customized them as needed. We used Uppy for the React frontend and a Java implementation for the backend.
            </p>
            <p>
