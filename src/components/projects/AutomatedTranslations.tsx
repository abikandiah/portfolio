...
export const automatedTranslationsProject: ProjectProps = {
    ...
    duration: '2019',
    description: `A Batch script and a Ruby script working together to translate all front-end and back-end user-facing text.`,
...
function Overview() {
    return (
        <>
            ...
            <p>
                A Batch script is used to call the translation script and to provide the paths for the language files in both the front-end and back-end. The target languages were defined in a file.
            </p>
        </>
    )
}
