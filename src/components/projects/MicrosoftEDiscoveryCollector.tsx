...
export const microsoftEDiscoveryProject: ProjectProps = {
    ...
    duration: '2022 - 2024',
    description: `An integration of Microsoft eDiscovery with our workflow automation platform, enabling users to perform Microsoft eDiscovery operations from our plaform.`,
...
function Overview() {
    return (
        <>
            <p>
                <span className="font-semibold">Microsoft eDiscovery</span> is an eDiscovery tool for Microsoft 365. eDiscovery managers can use it to search, review, export, and place legal holds on data across M365 services.
            </p>
            <p>
                This integration connects Microsoft eDiscovery to the rest of our platform, enabling users to perform Microsoft eDiscovery operations as part of their automated workflows. For example, a user can create an eDiscovery case, add custodians, place data on hold, filter for narrow data, and export it for processing through the rest of our available operations.
            </p>
            <p>
                A lot of organizations, and our clients, used M365 for their organization environment. Connecting information governance and collection from Microsoft 365 to our workflow automation platform bridged a gap that most had to deal with on their own. With our feature, clients can now run an entire M365 search, query, export, ingest, process and review workflow all within a single platform. We connected the M365 collection with our platform.
            </p>
            <Banner type="note" title="Automation Platform"
                message="The automation platform is truly a mix of many services. We bring together multiple data sources (such as Google Vault and Microsoft eDiscovery), processing platforms (such as Nuix) and review platforms (such as Nuix Discover and Relativity), then build configurable operations for them. These operations are then used to build all sorts of automated workflows."
            />
        </>
    )
}
...
function Architecture() {
    return (
        <>
            ...
            <p>
                The service configuration consists of everything required to connect to and manage Microsoft eDiscovery. This includes the Azure AD app registration and the OIDC connection details.
            </p>

            <h3 className="sub-heading">eDiscovery Operations</h3>
            <p>
                Operations were designed around the available eDiscovery API and typical use cases. We took a look at all the use cases and broke them up into modular operations. These operations then used to build various Microsoft eDiscovery workflows.
            </p>
            <p>
            ...
            <p>
                All API requests made to Microsoft eDiscovery are done through a REST client created and managed by our platform, with the following behaviours:
            </p>
            <UnorderedList>
            ...
            <p>
                The guided job wizard lives in the front-end and helps users fill in key operation details when submitting a Microsoft eDiscovery workflow. For example, details such as the case, the data sources, the queries, and the export download location.
            </p>
            <Banner type="note"
